...
```html
<template>
  <el-select :colNum="3" v-model="value" placeholder="请选择" @infiniteScroll="infiniteScroll">
    <el-option
...
```html
<template>
  <el-select :colNum="3" v-model="value" placeholder="请选择">
    <el-option
      v-for="item in options"
      :key="item.value"
      :label="item.label"
...
```html
<template>
  <el-select :colNum="3" v-model="value" disabled placeholder="请选择">
    <el-option
      v-for="item in options"
      :key="item.value"
      :label="item.label"
...
```html
<template>
  <el-select :colNum="3" v-model="value" clearable placeholder="请选择">
    <el-option
      v-for="item in options"
      :key="item.value"
      :label="item.label"
...
```html
<template>
  <el-select :colNum="3" v-model="value1" multiple placeholder="请选择">
    <el-option
      v-for="item in options"
      :key="item.value"
      :label="item.label"
...
```html
<template>
  <el-select :colNum="3" v-model="value" filterable placeholder="请选择">
    <el-option
      v-for="item in options"
      :key="item.value"
      :label="item.label"
